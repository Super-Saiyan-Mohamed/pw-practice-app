...
test.describe('Form Layout Page', () => {
    ...
    test('radio buttons', async({page}) => {
        ...
        const radioStatus2 = await radioOption2.isChecked();
        radioStatus1 = await radioOption1.isChecked();
...
test('web tables', async ({page}) => {
    ...
    const targetRowById = page.getByRole('row', {name: '11'}).filter({hasText: "@mark"});
